...
const CHUNK_DIR =
  process.env.CHUNK_UPLOAD_DIR ?? path.resolve("storage/chunks");

const MERGED_DIR =
  process.env.MERGED_UPLOAD_DIR ?? path.resolve("storage/merged");
...
const uploadChunk = async (req: Request, res: Response) => {
  try {
